YDBTUBE ;YottaDB Web Server; 05-07-2021
	;#################################################################
	;#                                                               #
	...
	;
ROUTES
	S YDBTUBE(":WS","ROUTES","POST","ydbtubeapi","API^YDBTUBEAPI")=""
	S YDBTUBE(":WS","ROUTES","OPTIONS","ydbtubeapi","API^YDBTUBEAPI")=""
	S YDBTUBE(":WS","ROUTES","GET","YDBTube","SERVESTATIC^YDBTUBEAPI")=""
	S YDBTUBE(":WS","ROUTES","GET","videos","GETVIDEOS^YDBTUBEAPI")=""
	S YDBTUBE(":WS","ROUTES","GET","images","GETIMGS^YDBTUBEAPI")=""
	;
	Q	
	;
Start(PORT) ;
	...
	S NOGLB=1
	I 1 J JOB(PORT) H 1 I '$T W !,"YDBTube Web Server could not be started!" Q
	S JOB=$ZJOB
	I '$$DirectoryExists^YDBTUBEUTILS("/tmp") D
	. W !,"Creating /tmp ..."
	. W:$$CreateDirectoryTree^YDBTUBEUTILS("/tmp") " succeeded" 
	ZSY "echo ""PID:"_JOB_",Port:"_PORT_""" > /tmp/YDBTUBE.info"
	W !,"YDBTube Web Server started successfully. Port: ",PORT," - PID: ",JOB,!
	Q
Stop;
	K
	W ! N SRC,LINE
	S SRC="/tmp/YDBTUBE.info"
	O SRC:(readonly)
	U SRC R LINE C SRC S LINE=$TR(LINE,$C(13))
	N PORT,PID
	S PID=$P($P(LINE,","),":",2)
	S PORT=$P($P(LINE,",",2),":",2)
	I 'PID W !!,"YDBTube Web Server could not be stopped!" Q
	ZSY "kill "_PID
	W !,"Killed PID: "_PID_". YDBTube Web Server stopped successfully.",!
...
RUN(HTTPREQ,HTTPRSP,HTTPARGS)
	...
	S PID=$P($P(LINE,","),":",2)
	S PORT=$P($P(LINE,",",2),":",2)
	S @HTTPRSP@(1)="YDBTube web server running on PID: "_PID_" and "_"Port: "_PORT
	Q       
	;
VIDS(HTTPREQ,HTTPRSP,HTTPARGS)
	...
	Q
JOB(TCPPORT)
	S @("$ZINTERRUPT=""I $$JOBEXAM^YDBTUBEZU($ZPOSITION)""")
...
WAIT
	...
	S HTTPREQ("body")="%YDBTUBEBODY" K @HTTPREQ("body")
	...
	S $ETRAP="G ETCODE^YDBTUBE"
	S HTTPERR=0
	D RESPOND
	S $ETRAP="G ETSOCK^YDBTUBE"
...
RESPOND
	...
	S HTTPRSP="%YDBTUBERESP" k @HTTPRSP
...
MATCHF(ROUTINE,ARGS,AUTHNODE)
	...
	I PATTERN="" S PATTERN="/"
	I PATTERN=""  S PATTERN="YDBTube"
	I PATTERN="/" S PATTERN="YDBTube"
	I '$D(YDBTUBE(":WS","ROUTES")) D ROUTES
	I $D(YDBTUBE(":WS","ROUTES",HTTPREQ("method"),PATTERN)) D
	. S ROUTINE=$O(YDBTUBE(":WS","ROUTES",HTTPREQ("method"),PATTERN,""))
	Q
SENDATA
	N %WBUFF S %WBUFF=""
...
GetMimeType(EXT)
	I $G(EXT)="" S EXT="*"
	S EXT=$$LOW^YDBTUBEUTILS(EXT)
	I '$D(YDBTUBE(":WS","MIME")) D
	. S YDBTUBE(":WS","MIME","html")="text/html" 
	. S YDBTUBE(":WS","MIME","htm")="text/html" 
	. S YDBTUBE(":WS","MIME","shtml")="text/html"
	. S YDBTUBE(":WS","MIME","css")="text/css"
	. S YDBTUBE(":WS","MIME","xml")="text/xml"
	. S YDBTUBE(":WS","MIME","gif")="image/gif"
	. S YDBTUBE(":WS","MIME","jpeg")="image/jpeg" 
	. S YDBTUBE(":WS","MIME","jpg")="image/jpeg"
	. S YDBTUBE(":WS","MIME","js")="application/javascript"
	. S YDBTUBE(":WS","MIME","atom")="application/atom+xml"
	. S YDBTUBE(":WS","MIME","rss")="application/rss+xml"
	. S YDBTUBE(":WS","MIME","mml")="text/mathml"
	. S YDBTUBE(":WS","MIME","txt")="text/plain"
	. S YDBTUBE(":WS","MIME","jad")="text/vnd.sun.j2me.app-descriptor"
	. S YDBTUBE(":WS","MIME","wml")="text/vnd.wap.wml"
	. S YDBTUBE(":WS","MIME","htc")="text/x-component"
	. S YDBTUBE(":WS","MIME","png")="image/png"
	. S YDBTUBE(":WS","MIME","tif")="image/tiff" 
	. S YDBTUBE(":WS","MIME","tiff")="image/tiff"
	. S YDBTUBE(":WS","MIME","wbmp")="image/vnd.wap.wbmp"
	. S YDBTUBE(":WS","MIME","ico")="image/x-icon"
	. S YDBTUBE(":WS","MIME","jng")="image/x-jng"
	. S YDBTUBE(":WS","MIME","bmp")="image/x-ms-bmp"
	. S YDBTUBE(":WS","MIME","svg")="image/svg+xml"
	. S YDBTUBE(":WS","MIME","svgz")="image/svg+xml"
	. S YDBTUBE(":WS","MIME","webp")="image/webp"
	. S YDBTUBE(":WS","MIME","woff")="application/font-woff"
	. S YDBTUBE(":WS","MIME","jar")="application/java-archive" 
	. S YDBTUBE(":WS","MIME","war")="application/java-archive"
	. S YDBTUBE(":WS","MIME","ear")="application/java-archive"
	. S YDBTUBE(":WS","MIME","json")="application/json"
	. S YDBTUBE(":WS","MIME","hqx")="application/mac-binhex40"
	. S YDBTUBE(":WS","MIME","doc")="application/msword"
	. S YDBTUBE(":WS","MIME","pdf")="application/pdf"
	. S YDBTUBE(":WS","MIME","ps")="application/postscript" 
	. S YDBTUBE(":WS","MIME","eps")="application/postscript" 
	. S YDBTUBE(":WS","MIME","ai")="application/postscript"
	. S YDBTUBE(":WS","MIME","rtf")="application/rtf"
	. S YDBTUBE(":WS","MIME","m3u8")="application/vnd.apple.mpegurl"
	. S YDBTUBE(":WS","MIME","xls")="application/vnd.ms-excel"
	. S YDBTUBE(":WS","MIME","eot")="application/vnd.ms-fontobject"
	. S YDBTUBE(":WS","MIME","ppt")="application/vnd.ms-powerpoint"
	. S YDBTUBE(":WS","MIME","wmlc")="application/vnd.wap.wmlc"
	. S YDBTUBE(":WS","MIME","kml")="application/vnd.google-earth.kml+xml"
	. S YDBTUBE(":WS","MIME","kmz")="application/vnd.google-earth.kmz"
	. S YDBTUBE(":WS","MIME","7z")="application/x-7z-compressed"
	. S YDBTUBE(":WS","MIME","cco")="application/x-cocoa"
	. S YDBTUBE(":WS","MIME","jardiff")="application/x-java-archive-diff"
	. S YDBTUBE(":WS","MIME","jnlp")="application/x-java-jnlp-file"
	. S YDBTUBE(":WS","MIME","run")="application/x-makeself"
	. S YDBTUBE(":WS","MIME","pl")="application/x-perl"
	. S YDBTUBE(":WS","MIME","pm")="application/x-perl"
	. S YDBTUBE(":WS","MIME","prc")="application/x-pilot" 
	. S YDBTUBE(":WS","MIME","pdb")="application/x-pilot"
	. S YDBTUBE(":WS","MIME","rar")="application/x-rar-compressed"
	. S YDBTUBE(":WS","MIME","rpm")="application/x-redhat-package-manager"
	. S YDBTUBE(":WS","MIME","sea")="application/x-sea"
	. S YDBTUBE(":WS","MIME","swf")="application/x-shockwave-flash"
	. S YDBTUBE(":WS","MIME","sit")="application/x-stuffit"
	. S YDBTUBE(":WS","MIME","tcl")="application/x-tcl"
	. S YDBTUBE(":WS","MIME","tk")="application/x-tcl"
	. S YDBTUBE(":WS","MIME","der")="application/x-x509-ca-cert"
	. S YDBTUBE(":WS","MIME","pem")="application/x-x509-ca-cert"
	. S YDBTUBE(":WS","MIME","crt")="application/x-x509-ca-cert"
	. S YDBTUBE(":WS","MIME","xpi")="application/x-xpinstall"
	. S YDBTUBE(":WS","MIME","xhtml")="application/xhtml+xml"
	. S YDBTUBE(":WS","MIME","xspf")="application/xspf+xml"
	. S YDBTUBE(":WS","MIME","zip")="application/zip"
	. S YDBTUBE(":WS","MIME","bin")="application/octet-stream" 
	. S YDBTUBE(":WS","MIME","exe")="application/octet-stream" 
	. S YDBTUBE(":WS","MIME","dll")="application/octet-stream"
	. S YDBTUBE(":WS","MIME","deb")="application/octet-stream"
	. S YDBTUBE(":WS","MIME","dmg")="application/octet-stream"
	. S YDBTUBE(":WS","MIME","iso")="application/octet-stream"
	. S YDBTUBE(":WS","MIME","img")="application/octet-stream"
	. S YDBTUBE(":WS","MIME","msi")="application/octet-stream"
	. S YDBTUBE(":WS","MIME","msp")="application/octet-stream"
	. S YDBTUBE(":WS","MIME","msm")="application/octet-stream"
	. S YDBTUBE(":WS","MIME","docx")="application/vnd.openxmlformats-officedocument.wordprocessingml.document"
	. S YDBTUBE(":WS","MIME","xlsx")="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
	. S YDBTUBE(":WS","MIME","pptx")="application/vnd.openxmlformats-officedocument.presentationml.presentation"
	. S YDBTUBE(":WS","MIME","mid")="audio/midi"
	. S YDBTUBE(":WS","MIME","midi")="audio/midi"
	. S YDBTUBE(":WS","MIME","kar")="audio/midi"
	. S YDBTUBE(":WS","MIME","mp3")="audio/mpeg"
	. S YDBTUBE(":WS","MIME","ogg")="audio/ogg"
	. S YDBTUBE(":WS","MIME","m4a")="audio/x-m4a"
	. S YDBTUBE(":WS","MIME","ra")="audio/x-realaudio"
	. S YDBTUBE(":WS","MIME","3gpp")="video/3gpp"
	. S YDBTUBE(":WS","MIME","3gp")="video/3gpp"
	. S YDBTUBE(":WS","MIME","ts")="video/mp2t"
	. S YDBTUBE(":WS","MIME","mp4")="video/mp4"
	. S YDBTUBE(":WS","MIME","mpeg")="video/mpeg"
	. S YDBTUBE(":WS","MIME","mpg")="video/mpeg"
	. S YDBTUBE(":WS","MIME","mov")="video/quicktime"
	. S YDBTUBE(":WS","MIME","webm")="video/webm"
	. S YDBTUBE(":WS","MIME","flv")="video/x-flv"
	. S YDBTUBE(":WS","MIME","m4v")="video/x-m4v"
	. S YDBTUBE(":WS","MIME","mng")="video/x-mng"
	. S YDBTUBE(":WS","MIME","asx")="video/x-ms-asf"
	. S YDBTUBE(":WS","MIME","asf")="video/x-ms-asf"
	. S YDBTUBE(":WS","MIME","wmv")="video/x-ms-wmv"
	. S YDBTUBE(":WS","MIME","avi")="video/x-msvideo"
	I $D(YDBTUBE(":WS","MIME",EXT)) Q YDBTUBE(":WS","MIME",EXT)
